...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(com.doohaa.chat.R.layout.em_activity_offline_push);

		inputNickName = (EditText) findViewById(com.doohaa.chat.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(com.doohaa.chat.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(com.doohaa.chat.R.id.tv_nickname_description);
