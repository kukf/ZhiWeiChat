...
import com.doohaa.chat.ui.own.CardActivity;
import com.doohaa.chat.widget.ChatRowVoiceCall;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public void onAvatarClick(String username) {
        ...
        intent.putExtra(CardActivity.MEMBER_ID, username);
        startActivity(intent);
    }
...
//        RPRedPacketUtil.getInstance().detachView();
    ...
    @Override
    public void goGardActivity(String userName) {
        super.goGardActivity(userName);
