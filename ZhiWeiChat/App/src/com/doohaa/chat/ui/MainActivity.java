...
import com.doohaa.chat.ui.group.GroupFragment;
import com.doohaa.chat.ui.login.LoginActivity;
import com.doohaa.chat.ui.own.OwnFragment;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments = new Fragment[]{conversationListFragment, contactListFragment, groupFragment, ownFragment};
        // 添加显示第一个fragment
    ...
    private void initView() {
        ...
        mTabs[2] = (Button) findViewById(R.id.btn_group);
        mTabs[3] = (Button) findViewById(R.id.btn_own);
        // 把第一个tab设为选中状态
...
//        saveInviteMsg(msg);
//        // 提示有新消息
//        IMHelper.getInstance().getNotifier().viberateAndPlayTone(null);
//
//        // 刷新bottom bar消息未读数
//        updateUnreadAddressLable();
//        // 刷新好友页面ui
