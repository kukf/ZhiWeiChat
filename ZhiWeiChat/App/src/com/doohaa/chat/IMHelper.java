...
import com.doohaa.chat.domain.EmojiconExampleGroupData;
import com.doohaa.chat.domain.InviteMessage;
import com.doohaa.chat.domain.RobotUser;
import com.doohaa.chat.parse.UserProfileManager;
import com.doohaa.chat.preferences.UserPreferences;
import com.doohaa.chat.receiver.CallReceiver;
import com.doohaa.chat.ui.ChatActivity;
import com.doohaa.chat.ui.MainActivity;
import com.doohaa.chat.ui.VideoCallActivity;
import com.doohaa.chat.ui.VoiceCallActivity;
...
import static com.doohaa.chat.domain.InviteMessage.InviteMessageStatus;
...
public class IMHelper {
    ...
    private IMModel demoModel = null;
...
//                    }
    ...
    public void resetCurrentUser() {
        UserDto userDto = UserPreferences.getInstance(IMApplication.getInstance().getApplicationContext()).getUser();
        if (Validator.isNotEmpty(userDto)) {
            String id = userDto.getFkImgPropertyId();
            String nick = userDto.getName();
            String avatar = UIUtils.getImageUrl(userDto);
            if (nick == null) {
                nick = "";
            }
            ...
            userProManager.uploadUserAvatar(avatar);
            userProManager.updateCurrentUserNickName(nick);
        }
    }
